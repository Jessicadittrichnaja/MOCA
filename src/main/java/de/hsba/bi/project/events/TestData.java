...
public class TestData {
    ...
    @EventListener(ApplicationStartedEvent.class)
        ...
        public void init() {
            // add some events
            Event programmierung = new Event ("Programmierung 2", "Ziel des Kurses Programmierung 2 ist das Erlernen grundlegender Konzepte der imperativen und objektorientierten Programmierung anhand der Programmiersprache Java.", Category.Seminar, 8, 1, Location.Hamburg, LocalDate.of(2021, 10, 23), LocalTime.of(10, 15));
